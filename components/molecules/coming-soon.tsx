...
export function MoleculesComingSoon() {
  return (
    <div className="flex flex-1 items-center justify-center px-12 py-8">
      <div className={`w-full max-w-md p-10 text-center ${PLAYGROUND_SURFACE_SHELL_CLASS}`}>
        ...
        <h1 className="font-title mt-3 text-[22px] font-semibold text-zinc-900">Molecules</h1>
        <p className="mt-3 text-[14px] leading-relaxed text-zinc-500">
          Composed patterns built from the atoms you already customize. Forms, cards, and navigation
          blocks with the same playground and copy-to-code workflow.
        </p>
