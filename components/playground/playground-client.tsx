    ...
    <div className="h-full min-h-0">
      <PlaygroundProviders>
        ...
        <div className="grid h-full min-h-0 flex-1 grid-cols-1 items-stretch gap-x-6 overflow-hidden [grid-template-rows:auto_auto_minmax(0,1fr)_auto] lg:grid-cols-[300px_minmax(0,1fr)] xl:grid-cols-[300px_minmax(0,1fr)_320px]">
          ...
          <div className="col-start-1 row-start-1 mb-6 min-w-0 shrink-0 lg:col-start-2">
          ...
          <div className="mt-3 hidden shrink-0 lg:col-start-1 lg:row-start-4 lg:flex">
            <AboutButton />
          </div>
          <div className="col-start-1 row-start-4 lg:col-start-2">
            <CtaStrip code={code} install={family.install} />
          </div>
          <div className="mt-3 hidden shrink-0 items-center justify-end xl:col-start-3 xl:row-start-4 xl:flex">
            <ViewGithubLink
              href={`${GITHUB_REPO}/blob/main/${family.githubPath}`}
            />
          </div>
        </div>
        </div>
