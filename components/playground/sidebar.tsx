            ...
            return (
              <div key={cat.id}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`size-4 shrink-0 text-zinc-400 opacity-0 transition-[opacity,transform] duration-200 group-hover/component-sidebar:opacity-100 ${
                      expanded ? "rotate-180" : ""
                    }`}
                    strokeWidth={2}
                  />
                ...
                <div
                  ...
                  style={{
                    gridTemplateRows: expanded ? "minmax(0, max-content)" : "0fr",
                  }}
                >
