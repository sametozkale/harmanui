      ...
      <div className="grid grid-cols-1 gap-x-6 lg:grid-cols-[300px_minmax(0,1fr)] xl:grid-cols-[300px_minmax(0,1fr)_320px]">
        ...
        >
          <div className="space-y-10">
              ...
              <section className="space-y-4">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {BENEFITS.map((benefit, index) => (
                    <Reveal key={benefit.title} delay={revealDelay(3.5 + index * 0.4)} y={8}>
            ...
            <Reveal delay={revealDelay(5.5)} y={10}>
              <section className="space-y-4">
                <h2 className="text-[11px] font-semibold uppercase tracking-wide text-zinc-400">
                  Built on
                </h2>
                <div className="grid grid-cols-4 gap-3">
                  {FOUNDATIONS.map((item, index) => (
                    <Reveal key={item.id} delay={revealDelay(6 + index * 0.35)} y={8}>
                      <div className="rounded-xl border border-zinc-100 bg-white px-4 py-4">
            ...
            <Reveal delay={revealDelay(7.5)} y={10}>
